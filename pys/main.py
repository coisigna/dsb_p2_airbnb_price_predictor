...
madrid = os.path.join(abs_path, "..", "resources", "datasets", "madrid.csv")
barcelona = os.path.join(abs_path, "..", "resources", "datasets", "barcelona.csv")
london = os.path.join(abs_path, "..", "resources", "datasets", "london.csv")
...
>>>>>>> 3e3c2aa63a806fd527516e5870c6f0cc54c83f30
...
if check_prediction:
    ...
    model_madrid_barcelona = instance_prediction.load_model_joblib("model_madrid_barcelona", "sav")
    model_london = instance_prediction.load_model_joblib("model_london", "sav")
